...
<body>
    ...
    <jsp:useBean id="ogrenci" type="Ogrenci" class="bean.pojo.DershaneOgrenci" scope="request">
        <!-- Type'i kullanarak sonraki coderlara hangi siniftan olustugunu not olarak gosterebiliriz -->
    ...
    <jsp:useBean id="ogrenci2" type="Ogrenci" class="bean.pojo.DershaneOgrenci" scope="request"></jsp:useBean> <!-- Burada ogrenci2 olusturuldu -->
    ...
    <jsp:useBean id="ogrenci3" type="Ogrenci" class="bean.pojo.DershaneOgrenci" scope="request">
